...
rm -rf passwall2  # luci-app-passwall2  

git clone https://github.com/kenzok8/small && rm -rf small/{luci-app-passwall,luci-app-passwall2}  
mvdir small  # 翻越长城app及依赖  
